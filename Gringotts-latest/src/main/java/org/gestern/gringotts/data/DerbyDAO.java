...
public class DerbyDAO implements DAO {
    ...
    /* (non-Javadoc)
     * @see DAO#storeAccountChest(org.gestern.gringotts.AccountChest)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see DAO#destroyAccountChest(org.gestern.gringotts.AccountChest)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see DAO#storeAccount(org.gestern.gringotts.GringottsAccount)
     */
    @Override
    public synchronized boolean storeAccount(GringottsAccount account) {
        ...
        try {
            ...
            storeAccount.setLong(3, Configuration.CONF.currency.centValue(value));
    ...
    /* (non-Javadoc)
     * @see DAO#getChests(org.gestern.gringotts.GringottsAccount)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see DAO#storeCents(org.gestern.gringotts.GringottsAccount, long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see DAO#getCents(org.gestern.gringotts.GringottsAccount)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see DAO#deleteAccount(org.gestern.gringotts.GringottsAccount)
     */
    @Override
