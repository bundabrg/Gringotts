...
public class GringottsEco implements Eco {
    ...
    public Currency currency() {
        return new Curr(Configuration.CONF.currency);
    }
    ...
    private class ValidAccount implements Account {
        ...
        @Override
        public double balance() {
            return Configuration.CONF.currency.displayValue(acc.balance());
        }

        @Override
        public double vaultBalance() {
            return Configuration.CONF.currency.displayValue(acc.vaultBalance());
        }

        @Override
        public double invBalance() {
            return Configuration.CONF.currency.displayValue(acc.invBalance());
        }

        @Override
        public boolean has(double value) {
            return acc.balance() >= Configuration.CONF.currency.centValue(value);
        }
        ...
        public TransactionResult add(double value) {
            ...
            return acc.add(Configuration.CONF.currency.centValue(value));
        }
        ...
        public TransactionResult remove(double value) {
            ...
            return acc.remove(Configuration.CONF.currency.centValue(value));
        }
    ...
    private class ValidPlayerAccount extends ValidAccount implements PlayerAccount {
        ...
        public TransactionResult deposit(double value) {
            ...
            long                centValue       = Configuration.CONF.currency.centValue(value);
            ...
            TransactionResult result = player(player.getUniqueId()).add(Configuration.CONF.currency.displayValue(toDeposit));
    ...
    private class Curr implements Currency {
        ...
        public String format(double value) {
            return Configuration.CONF.currency.format(formatString, value);
        }
