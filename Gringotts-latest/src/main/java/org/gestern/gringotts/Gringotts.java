...
public class Gringotts extends VersionPlugin {
    ...
    public Gringotts(MultiVersionPlugin plugin) {
        super(plugin);
    ...
    public void onEnable() {
        ...
        try {
            ...
            try {
                MetricsLite metrics = new MetricsLite(getJavaPlugin());
                metrics.start();
    ...
    private void registerEvents() {
        ...
        manager.registerEvents(new AccountListener(), getJavaPlugin());
        manager.registerEvents(new PlayerVaultListener(), getJavaPlugin());
        manager.registerEvents(new VaultCreator(), getJavaPlugin());
    ...
    private void registerEconomy() {
        if (DEP.vault.exists()) {
            ...
            sm.register(Economy.class, new VaultConnector(), getJavaPlugin(), ServicePriority.Highest);
