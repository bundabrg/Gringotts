...
public class VaultConnector implements Economy {
    ...
    private EconomyResponse withdrawPlayer(Account account, double amount) {
        ...
        switch (removed) {
            ...
            case INSUFFICIENT_FUNDS:
                return new EconomyResponse(0, account.balance(), ResponseType.FAILURE, Language.LANG
                        .plugin_vault_insufficientFunds);
            case ERROR:
            default:
                return new EconomyResponse(0, account.balance(), ResponseType.FAILURE, Language.LANG.plugin_vault_error);
        }
    }
    ...
    public EconomyResponse createBank(String name, String player) {
        return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED, Language.LANG.plugin_vault_notImplemented);
